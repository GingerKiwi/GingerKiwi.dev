const BuildingInPublic = () => {
    return (
        <section className="section--building-in-public">
            ...
            <ul>
                <li>- The 'problem solved' statements in the project cards will be rendered as accessible modals.</li>
                <li>- Lack of whitespace and other css/design issues will be fixed.</li>
                <li>Better organize assets and clean up unused/commented out code.</li>
